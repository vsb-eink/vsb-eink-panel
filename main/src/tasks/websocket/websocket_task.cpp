    ...
    switch (event_id) {
        ...
        case WEBSOCKET_EVENT_DATA: {
            ...
            if (is_first_chunk) {
                ...
                ESP_LOGI(TAG, "Received message of type %d", to_underlying(state->message_type));
            }
            ...
            eink_panel_event_data.data_ptr = data_ptr;
            eink_panel_event_data.data_len = data_len;
            eink_panel_event_data.payload_offset = payload_offset;
            eink_panel_event_data.payload_len = payload_len;
        ...
        case WEBSOCKET_EVENT_ERROR:
            ...
            break;
        default:
            ESP_LOGE(TAG, "Unexpected event %ld", event_id);
            break;
    }
}
...
void websocket_task(void *pvParameters) {
    ...
    websocket_cfg.uri = websocket_url.c_str();
    websocket_cfg.task_stack = 8096;
    websocket_cfg.headers = authorizationHeader.c_str();

    websocket_message_state state = {};
    state.shared = shared;
    state.message_type = EInkPanelEvent::NOOP;
